...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        img = outPutImage("axial")
        print(img)
        self.photo.setPixmap(QtGui.QPixmap("axial.png"))
    ...
    def show_dog(self):
        img = outPutImage("sagittal")
        self.photo.setPixmap(QtGui.QPixmap("sagittal.png"))

    def show_cat(self):
        img = outPutImage("coronal")

        self.photo.setPixmap(QtGui.QPixmap("coronal.png"))
